...
class TradeConsumer(AsyncWebsocketConsumer):
    ...
    def time_format(self, position):
        return str(position.year) + "-" + str(position.month) + "-" + str(position.day) + " " + str(
            position.hour) + ":" + str(position.minute)
        ...
        if position_option:
            set_data = {
                ...
                "position_option": {
                    ...
                    "oreder_reach_date": self.time_format(position_option[0].oreder_reach_date) if position_option[
                        0].oreder_reach_date else "",
                }
            }
